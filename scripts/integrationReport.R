...
rmarkdown::render("/data/CCBR/projects/ccbr1227/workflow/scripts/integrationReports.Rmd", output_file=paste0("QC_Report_",contrasts,".html"),output_dir = outputDir,
